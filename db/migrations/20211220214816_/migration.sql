/*
  ...
  - Made the column `sellPrice` on table `Sponsorlevel` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_Item" ("amountAvailable", "availableEndDate", "createdAt", "description", "eventId", "id", "imageId", "included", "isAvailable", "isClubMemberFree", "isClubMemberOnly", "limit", "mandatory", "name", "oneOfGroup", "preselected", "sellPrice", "updatedAt") SELECT "amountAvailable", "availableEndDate", "createdAt", "description", "eventId", "id", "imageId", "included", "isAvailable", "isClubMemberFree", "isClubMemberOnly", "limit", "mandatory", "name", "oneOfGroup", "preselected", coalesce("sellPrice", 0) AS "sellPrice", "updatedAt" FROM "Item";
DROP TABLE "Item";
